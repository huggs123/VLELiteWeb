...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="messagetutor.php">Messages</a>
      </li>           
      </li>
      <li class="nav-item">
...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-3">
			...
			<div class="col-9">
				...
				<h1 class ='header'>Tutor Admin Page</h1>
		  <?php 
	...
	<div class = "homepage">
			<a href="profiletutor.php"><h3>Profile Page</h3></a>
	</div>
	
	
	<div class = "homepage">
		<a href="coursestutor.php"><h3>Courses</h3></a>
	</div>
	
	<div class = "homepage">
		<a href="messagetutor.php"><h3>Messages</h3></a>
	</div>
