...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="message.php">Messages<span class="sr-only">(current)</a>
      </li>        
      </li>
      <li class="nav-item">
...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<div><a href='messagesend.php' role='button' class='btn btn-outline-dark'>Send New Message</a></div>
	...
	<?php
			...
			while ($row=$messages->fetch_assoc()){
				...
				if($read != 1){		
			echo"
				  <a href='messageread.php?messageid=$messageid' class='boldread'><div class='row'>
						<div class='col-sm'>
							<div>$first $last $new</div>
						</div>
				<div class='col-sm'>
							<div>$subject</div>
						</div>
			...
			";
							...
							echo"
				  <a href='messageread.php?messageid=$messageid'><div class='row'>
						<div class='col-sm'>
							<div>$first $last $new</div>
						</div>
				<div class='col-sm'>
