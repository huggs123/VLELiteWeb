...
session_start();
	...
	echo"	
	<script>
       alert('Students added/removed successfully');
    </script>";
	}
	...
	$read = "SELECT * FROM `cater_courses`";
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-9">
      ...
      <h1 class ='header'>Select Course to Enrol Students In</h1>
	  <?php 
			...
			echo"<div><a href='enrolstudents.php?id=$courseid&coursetitle=$coursetitle'>$coursetitle<a></div>";
