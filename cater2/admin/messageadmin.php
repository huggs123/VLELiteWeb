...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<div><a href='messagesendadmin.php' role='button' class='btn btn-outline-dark'>Send New Message</a></div>
	...
	<?php
			...
			echo"
				  ...
				  <a href='messagereadadmin.php?messageid=$messageid' class='boldread'><div class='row'>
						<div class='col-3'>
							<div>$first $last</div>
						</div>
				<div class='col-6'>
			...
			echo"
				  ...
				  <a href='messagereadadmin.php?messageid=$messageid'><div class='row'>
						<div class='col-3'>
							<div>$first $last</div>
						</div>
				<div class='col-6'>
