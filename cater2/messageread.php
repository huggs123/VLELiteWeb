...
<?php
echo"
  <a href='message.php' role='button' class='btn btn-outline-dark'>Back</a>	

  <div class = 'coursebutton'><a href='process/processdeletemessagestu.php?sendid=$messid' role='button' class='btn btn-outline-dark deletok'>Delete Message</a></div>";
