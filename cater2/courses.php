...
session_start();
	...
	$read2 = "SELECT * FROM `cater_enrol` INNER JOIN cater_courses ON cater_enrol.course = cater_courses.id WHERE cater_enrol.student = '$userid'";
  ...
  <div class="row">
    ...
    <div class="col-9">
	  ...
	  <?php 
				...
				echo"<p><a href='coursedetail.php?id=$courseid&title=$title_data'>$coursetitle</a></p>
				";
				}
?>
