...
session_start();
	...
	$readtutors = "SELECT * FROM `cater_users` WHERE`userrights`= '2'";
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-9">
      ...
      <h1 class ='header'>Send Message to Tutor</h1>
...
?>					</select>
			...
			<button type='Update Info' class='btn btn-outline-dark'>Send Message</button>			
